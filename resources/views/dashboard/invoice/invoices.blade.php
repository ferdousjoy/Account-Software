...
<div class="app-content content">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="title">
                Challan <a href="{{Route('new_invoice')}}"
                ...
                <table id="notestable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$invoice->chalan_name}}</td>
                            <td>{{$invoice->track_number}}</td>
                            <td>{{$invoice->quantity}}</td>
                            <td>

                         <a href="{{Route('edit_invoice',$invoice->id)}}" class="btn btn-sm btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form method="POST" action="{{Route('delete_invoice',$invoice->id)}}">
                                        @csrf
                                        @method('delete')
