...
<div class="app-content content">
  ...
  <section style="background: url({{asset('images/bg2.png')}});
         padding: 40px 0;
...
margin: auto;">
                     <tr>
                         <td style="text-align: right">
                             <div><img style="width:115px;
    height:115px;" src="{{asset('images/logo.jpg')}}" alt=""></div>
                         </td>
                         <td style="text-align:center">
                             <div>
                                 <h1 class="main_title">ORIKA CORPORATION</h1>
                                 <p class="main-adress">Corporate office: 557/4, (1st floor), Shameem Sarani, Shewrapara,<br>
                         ...
                         <td style="text-align:left">
                             <div class="delivery" style="padding-top:5px;
    text-align: left;">
                                 <h6 style="font-size: 22px;">Delivery Notes</h6>
                                 <p style="  font-size: 16px;
    font-weight: 500;
    font-family: 'Playfair Display', serif;
    padding-left: 20px;">(Customer Copy ) </p>
                             </div>
                         </td>
                     </tr>
                 ...
                 <table style="width:100%; margin-top:20px;">
                     <tr>
                         <td>
                             <div class="address">
                                 <div class="ship">
                                     <h6 style="color: #5e5e5e;
    font-size: 17px;
    text-transform: uppercase;
    font-weight: 600;
    padding-top: 5px;">SHIP TO</h6>
                                     <h5> </h5>
                                     <p>  </p>
                                 </div>
                             </div>
                         ...
                         <td style="transform: translateY(-15px);">
                             <div class="address2">
                                 <div class="delivery_notes">
                                     <h6><span>Delivery Notes No: </span> </h6>
                                     <p><span>date:</span>  </p>
                                     <p><span>P.O. No:</span> </p>
             ...
             <div class="row">
                 <table style="width:100%">
                     <tr>
                         ...
                         <td style="text-align: right;">
                             <div class="driver">
                                 <p><span>Driver Mobile No:</span>  </p>
                             </div>
                         </td>
                     </tr>
                 </table>
