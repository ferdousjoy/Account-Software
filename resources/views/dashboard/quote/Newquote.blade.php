                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="input-group" style="margin-left:20px">
                                      ...
                                      <textarea  id="invovie_num" class="form-control rounded" name="purchase_order" placeholder="Invoice Number"  style="max-width:200px;height:41px;border-radius:4px; resize:none;"> {{$quote+1}}</textarea>
                                    </div>
                                  </div>
                                </div>
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-4">
                                                  <div class="row">
                                                      ...
                                                      <div class="col-md-6">
                                                          <select name="cus_name" class="form-control js-example-basic-single" id="customer_id">
