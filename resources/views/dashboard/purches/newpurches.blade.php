                          ...
                          <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <input type="date" class="form-control"  name="Issue_date" data-toggle="datepicker" autocomplete="false">
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <input type="date" class="form-control"  name="expire_date" data-toggle="datepicker" autocomplete="false">
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
