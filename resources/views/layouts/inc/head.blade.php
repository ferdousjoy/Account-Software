...
<link href="{{asset('dashjscss')}}/assets/c_portcss/custom.css?v=?v=3.553" rel="stylesheet"/>
    ...
    <script type="text/javascript" src="{{asset('dashjscss')}}/app-assets/vendors/js/ui/jquery.sticky.js"></script>
    <script type="text/javascript" src="{{asset('dashjscss')}}/app-assets/vendors/js/charts/jquery.sparkline.min.js"></script>
    <script src="{{asset('dashjscss')}}/assets/portjs/raphael.min.js" type="text/javascript"></script>
    <script src="{{asset('dashjscss')}}/assets/portjs/morris.min.js" type="text/javascript"></script>
